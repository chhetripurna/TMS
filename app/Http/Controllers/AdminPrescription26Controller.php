<?php namespace App\Http\Controllers;
	...
	class AdminPrescription26Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Treatment Date","name"=>"Date"];
			$this->col[] = ["label"=>"Patient ID","name"=>"Patient_ID"];
			$this->col[] = ["label"=>"Doctor Name","name"=>"cms_users_id","join"=>"cms_users,name"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			//$this->form[] = ['label'=>'Name','name'=>'Name','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Patient ID','name'=>'Patient_ID','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Prescriptions','name'=>'Prescriptions','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Patient Visit ID','name'=>'Patient_Visit_ID','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Patient ID","name"=>"Patient_ID","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Prescriptions","name"=>"Prescriptions","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Patient Visit ID","name"=>"Patient_Visit_ID","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
