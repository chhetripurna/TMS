<?php namespace App\Http\Controllers;
	...
	class AdminVisitController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Patient CID','name'=>'Patient_Register_ID','type'=>'datamodal','validation'=>'required','width'=>'col-sm-6','datamodal_table'=>'patient','datamodal_columns'=>'Name,CID','datamodal_columns_alias'=>'Name,CID','datamodal_size'=>'small'];
...
//$this->sub_module[] = ['label'=>'Doctor Note','path'=>'prescription','foreign_key'=>'Patient_Visit_ID','button_color'=>'primary','button_icon'=>'fa fa-bars','parent_columns'=>'Name,Patient_Register_ID,Level,Bed_Num'];
	        ...
	        */
	        ...
	        //$this->addaction[] = ['label'=>'Set Pending','url'=>CRUDBooster::mainpath('set-status/Pending/[id]'),'icon'=>'fa fa-ban','color'=>'warning','showIf'=>"[is_active] == 'Examined'"];
	         //$this->addaction[] = ['label'=>'Doctor Notes','url'=>CRUDBooster::adminPath('prescription/add?id=[id]'),'icon'=>'fa fa-check','color'=>'success'];
