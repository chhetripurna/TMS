<?php namespace App\Http\Controllers;
	...
	class AdminVisitController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"First Name","name"=>"Patient_Register_ID","join"=>"patient,First_Name"];
			$this->col[] = ["label"=>" Last Name","name"=>"Patient_Register_ID","join"=>"patient,Last_Name"];
			...
			$this->form[] = ['label'=>'Bed No','name'=>'Bed_Num','type'=>'select','validation'=>'required|min:0','width'=>'col-sm-6','datatable'=>'bed,Bed_No','parent_select'=>'Room_Num','datatable_where'=>'Status!="Occupied"'];
			
			$this->form[] = ['label'=>'Traige','name'=>'id','type'=>'header','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Blood Presure','name'=>'BloodPresure','type'=>'text','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Temperature','name'=>'Temperature','type'=>'text','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Heart Rate','name'=>'HeartRate','type'=>'text','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'SPO2','name'=>'SpO2','type'=>'text','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'RBS','name'=>'Rbs','type'=>'text','validation'=>'string','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Respiration','name'=>'Respiration','type'=>'text','validation'=>'string','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Allergies','name'=>'Allergies','type'=>'text','validation'=>'string','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'GCS Score','name'=>'GCSScore','type'=>'text','validation'=>'string','width'=>'col-sm-5'];
			$this->form[] = ['label'=>'Level','name'=>'level','type'=>'radio','validation'=>'required','width'=>'col-sm-5','dataenum'=>'Immediate;Urgent;Delay;Death'];
	        ...
	        */
	        ...
	        // $this->sub_module [] = ['label'=>'Create Prescription', 'path'=>'prescription', 'parent_columns'=>'id,cid,level','foreign_key'=>'id', 'button_color'=>'success', 'button_icon'=>'fa fa-bars'];
	          $this->sub_module[] = ['label'=>'Prescribe','path'=>'prescription','foreign_key'=>'Patient_Visit_ID','button_color'=>'primary','button_icon'=>'fa fa-bars','parent_columns'=>'Patient_Register_ID,Level,Bed_Num'];
	       ...
	       //$this->addaction[] = ['label'=>'Set Active','icon'=>'fa fa-money','color'=>'warning','url'=>CRUDBooster::mainpath('').'/[id]','showIf'=>'[is_active] == "Done"'];
	        
	        //add set pending button
	       // $this->addaction[] = ['label'=>'Set Active','url'=>CRUDBooster::mainpath('set-status/pending/[id]'),'icon'=>'fa fa-check','color'=>'success','showIf'=>"[is_active] == 'pending'"];
	       ...
	       // $this->table_row_color[] = ['condition'=>"[is_active] == 'active'","color"=>"danger"];  	
