    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
       ...
       <!-- <p class='login-box-msg'>{{trans("crudbooster.login_message")}}</p>-->
        <center><h3>Triage Management System</h3></center>
      <center>(JDWNRH)</center><br>
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
      <input type="hidden" name="_token" value="{{ csrf_token() }}" />
          <div class="form-group has-feedback">
            <input autocomplete='on'  type="text" class="form-control" name='email' required placeholder="Email"/>
